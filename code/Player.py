...
from code.Const import ENTITY_SPEED, WIN_HEIGHT, WIN_WIDTH, PLAYER_KEY_UP, PLAYER_RIGHT, PLAYER_LEFT, PLAYER_DOWN, \
    PLAYER_SHOOT, ENTITY_SHOT_DELAY
...
class Player(Entity):
    ...
    def move(self, ): # PLAYER'S MOVEMENT
